...
public class Accessor {
    public static long staticFieldOffset(Class<?> type, String name) {
        return Unsafe.staticFieldOffset(Fields.get(type, name));
    }

    public static long objectFieldOffset(Class<?> type, String name) {
        return Unsafe.objectFieldOffset(Fields.get(type, name));
    }
    ...
    public static void putReference(Field field, Object value) {
        Unsafe.putReference(field.getDeclaringClass(), Unsafe.staticFieldOffset(field), value);
    }
    ...
    public static void putAddress(Field field, long value) {
        Unsafe.putAddress(field.getDeclaringClass(), Unsafe.staticFieldOffset(field), value);
    }
    ...
    public static void putReferenceVolatile(Field field, Object value) {
        Unsafe.putReferenceVolatile(field.getDeclaringClass(), Unsafe.staticFieldOffset(field), value);
    }
    ...
    public static <T> void copyBoolean(T to, T from, String fieldName) {
        long offset = Unsafe.objectFieldOffset(Fields.get(to, fieldName));
    ...
    public static void copyBoolean(Class<?> to, Class<?> from, String fieldName) {
        long offset = Unsafe.staticFieldOffset(Fields.get(to, fieldName));
    ...
    public static void copyAddress(Object to, Object from, String fieldName) {
        ...
        Unsafe.putAddress(to, offset, Unsafe.getAddress(from, offset));
    }
    ...
    public static <T> void copy(T to, T from, String fieldName) {
        Field field = Fields.get(to, fieldName);
        long offset = Unsafe.objectFieldOffset(field);
    ...
    public static <T> void copyObjectVolatile(T to, T from, String fieldName) {
        ...
        Unsafe.putReferenceVolatile(to, offset, Unsafe.getReferenceVolatile(from, offset));
    }
    ...
    public static boolean getBoolean(Object object, String fieldName) {
        return Unsafe.getBoolean(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putBoolean(Object object, String fieldName, boolean value) {
        Unsafe.putBoolean(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static boolean getBoolean(Class<?> type, String fieldName) {
        return Unsafe.getBoolean(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putBoolean(Class<?> type, String fieldName, boolean value) {
        Unsafe.putBoolean(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static byte getByte(Object object, String fieldName) {
        return Unsafe.getByte(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putByte(Object object, String fieldName, byte value) {
        Unsafe.putByte(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static byte getByte(Class<?> type, String fieldName) {
        return Unsafe.getByte(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putByte(Class<?> type, String fieldName, byte value) {
        Unsafe.putByte(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static char getChar(Object object, String fieldName) {
        return Unsafe.getChar(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putChar(Object object, String fieldName, char value) {
        Unsafe.putChar(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static char getChar(Class<?> type, String fieldName) {
        return Unsafe.getChar(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putChar(Class<?> type, String fieldName, char value) {
        Unsafe.putChar(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static short getShort(Object object, String fieldName) {
        return Unsafe.getShort(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putShort(Object object, String fieldName, short value) {
        Unsafe.putShort(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static short getShort(Class<?> type, String fieldName) {
        return Unsafe.getShort(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putShort(Class<?> type, String fieldName, short value) {
        Unsafe.putShort(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static int getInt(Object object, String fieldName) {
        return Unsafe.getInt(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putInt(Object object, String fieldName, int value) {
        Unsafe.putInt(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static int getInt(Class<?> type, String fieldName) {
        return Unsafe.getInt(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putInt(Class<?> type, String fieldName, int value) {
        Unsafe.putInt(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static long getLong(Object object, String fieldName) {
        return Unsafe.getLong(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putLong(Object object, String fieldName, long value) {
        Unsafe.putLong(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static long getLong(Class<?> type, String fieldName) {
        return Unsafe.getLong(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putLong(Class<?> type, String fieldName, long value) {
        Unsafe.putLong(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static float getFloat(Object object, String fieldName) {
        return Unsafe.getFloat(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putFloat(Object object, String fieldName, float value) {
        Unsafe.putFloat(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static float getFloat(Class<?> type, String fieldName) {
        return Unsafe.getFloat(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putFloat(Class<?> type, String fieldName, float value) {
        Unsafe.putFloat(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static double getDouble(Object object, String fieldName) {
        return Unsafe.getDouble(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putDouble(Object object, String fieldName, double value) {
        Unsafe.putDouble(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static double getDouble(Class<?> type, String fieldName) {
        return Unsafe.getDouble(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putDouble(Class<?> type, String fieldName, double value) {
        Unsafe.putDouble(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }

    public static <T> T getReference(Object object, Field fieldName) {
        return Unsafe.getReference(object, Unsafe.objectFieldOffset(fieldName));
    }

    public static void putReference(Object object, Field fieldName, Object value) {
        Unsafe.putReference(object, Unsafe.objectFieldOffset(fieldName), value);
    }

    public static <T> T getReference(Object object, String fieldName) {
        return Unsafe.getReference(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putReference(Object object, String fieldName, Object value) {
        Unsafe.putReference(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static <T> T getReference(Class<?> type, String fieldName) {
        return Unsafe.getReference(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putReference(Class<?> type, String fieldName, Object value) {
        Unsafe.putReference(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }

    public static long getAddress(Object object, Field fieldName) {
        return Unsafe.getAddress(object, Unsafe.objectFieldOffset(fieldName));
    }

    public static void putAddress(Object object, Field fieldName, long value) {
        Unsafe.putAddress(object, Unsafe.objectFieldOffset(fieldName), value);
    }

    public static long getAddress(Object object, String fieldName) {
        return Unsafe.getAddress(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putAddress(Object object, String fieldName, long value) {
        Unsafe.putAddress(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static long getAddress(Class<?> type, String fieldName) {
        return Unsafe.getAddress(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putAddress(Class<?> type, String fieldName, long value) {
        Unsafe.putAddress(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static Object get(Object object, String fieldName) {
        Field field = Fields.get(object, fieldName);
    ...
    public static Object get(Class<?> type, String fieldName) {
        Field field = Fields.get(type, fieldName);
    ...
    public static boolean getBooleanVolatile(Object object, String fieldName) {
        return Unsafe.getBooleanVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putBooleanVolatile(Object object, String fieldName, boolean value) {
        Unsafe.putBooleanVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static boolean getBooleanVolatile(Class<?> type, String fieldName) {
        return Unsafe.getBooleanVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putBooleanVolatile(Class<?> type, String fieldName, boolean value) {
        Unsafe.putBooleanVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static byte getByteVolatile(Object object, String fieldName) {
        return Unsafe.getByteVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putByteVolatile(Object object, String fieldName, byte value) {
        Unsafe.putByteVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static byte getByteVolatile(Class<?> type, String fieldName) {
        return Unsafe.getByteVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putByteVolatile(Class<?> type, String fieldName, byte value) {
        Unsafe.putByteVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static char getCharVolatile(Object object, String fieldName) {
        return Unsafe.getCharVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putCharVolatile(Object object, String fieldName, char value) {
        Unsafe.putCharVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static char getCharVolatile(Class<?> type, String fieldName) {
        return Unsafe.getCharVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putCharVolatile(Class<?> type, String fieldName, char value) {
        Unsafe.putCharVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static short getShortVolatile(Object object, String fieldName) {
        return Unsafe.getShortVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putShortVolatile(Object object, String fieldName, short value) {
        Unsafe.putShortVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static short getShortVolatile(Class<?> type, String fieldName) {
        return Unsafe.getShortVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putShortVolatile(Class<?> type, String fieldName, short value) {
        Unsafe.putShortVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static int getIntVolatile(Object object, String fieldName) {
        return Unsafe.getIntVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putIntVolatile(Object object, String fieldName, int value) {
        Unsafe.putIntVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static int getIntVolatile(Class<?> type, String fieldName) {
        return Unsafe.getIntVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putIntVolatile(Class<?> type, String fieldName, int value) {
        Unsafe.putIntVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static long getLongVolatile(Object object, String fieldName) {
        return Unsafe.getLongVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putLongVolatile(Object object, String fieldName, long value) {
        Unsafe.putLongVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static long getLongVolatile(Class<?> type, String fieldName) {
        return Unsafe.getLongVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putLongVolatile(Class<?> type, String fieldName, long value) {
        Unsafe.putLongVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static float getFloatVolatile(Object object, String fieldName) {
        return Unsafe.getFloatVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putFloatVolatile(Object object, String fieldName, float value) {
        Unsafe.putFloatVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static float getFloatVolatile(Class<?> type, String fieldName) {
        return Unsafe.getFloatVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putFloatVolatile(Class<?> type, String fieldName, float value) {
        Unsafe.putFloatVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static double getDoubleVolatile(Object object, String fieldName) {
        return Unsafe.getDoubleVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putDoubleVolatile(Object object, String fieldName, double value) {
        Unsafe.putDoubleVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static double getDoubleVolatile(Class<?> type, String fieldName) {
        return Unsafe.getDoubleVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putDoubleVolatile(Class<?> type, String fieldName, double value) {
        Unsafe.putDoubleVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }

    public static <T> T getReferenceVolatile(Object object, Field fieldName) {
        return Unsafe.getReferenceVolatile(object, Unsafe.objectFieldOffset(fieldName));
    }

    public static void putReferenceVolatile(Object object, Field fieldName, Object value) {
        Unsafe.putReferenceVolatile(object, Unsafe.objectFieldOffset(fieldName), value);
    }

    public static <T> T getReferenceVolatile(Object object, String fieldName) {
        return Unsafe.getReferenceVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)));
    }

    public static void putReferenceVolatile(Object object, String fieldName, Object value) {
        Unsafe.putReferenceVolatile(object, Unsafe.objectFieldOffset(Fields.get(object, fieldName)), value);
    }

    public static <T> T getReferenceVolatile(Class<?> type, String fieldName) {
        return Unsafe.getReferenceVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putReferenceVolatile(Class<?> type, String fieldName, Object value) {
        Unsafe.putReferenceVolatile(type, Unsafe.staticFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static boolean getBoolean(Object object, Class<?> type, String fieldName) {
        return Unsafe.getBoolean(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putBoolean(Object object, Class<?> type, String fieldName, boolean value) {
        Unsafe.putBoolean(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static byte getByte(Object object, Class<?> type, String fieldName) {
        return Unsafe.getByte(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putByte(Object object, Class<?> type, String fieldName, byte value) {
        Unsafe.putByte(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static char getChar(Object object, Class<?> type, String fieldName) {
        return Unsafe.getChar(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putChar(Object object, Class<?> type, String fieldName, char value) {
        Unsafe.putChar(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static short getShort(Object object, Class<?> type, String fieldName) {
        return Unsafe.getShort(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putShort(Object object, Class<?> type, String fieldName, short value) {
        Unsafe.putShort(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static int getInt(Object object, Class<?> type, String fieldName) {
        return Unsafe.getInt(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putInt(Object object, Class<?> type, String fieldName, int value) {
        Unsafe.putInt(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static long getLong(Object object, Class<?> type, String fieldName) {
        return Unsafe.getLong(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putLong(Object object, Class<?> type, String fieldName, long value) {
        Unsafe.putLong(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static float getFloat(Object object, Class<?> type, String fieldName) {
        return Unsafe.getFloat(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putFloat(Object object, Class<?> type, String fieldName, float value) {
        Unsafe.putFloat(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static double getDouble(Object object, Class<?> type, String fieldName) {
        return Unsafe.getDouble(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putDouble(Object object, Class<?> type, String fieldName, double value) {
        Unsafe.putDouble(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static <T> T getReference(Object object, Class<?> type, String fieldName) {
        return Unsafe.getReference(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putReference(Object object, Class<?> type, String fieldName, Object value) {
        Unsafe.putReference(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static long getAddress(Object object, Class<?> type, String fieldName) {
        return Unsafe.getAddress(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putAddress(Object object, Class<?> type, String fieldName, long value) {
        Unsafe.putAddress(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static boolean getBooleanVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getBooleanVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putBooleanVolatile(Object object, Class<?> type, String fieldName, boolean value) {
        Unsafe.putBooleanVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static byte getByteVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getByteVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putByteVolatile(Object object, Class<?> type, String fieldName, byte value) {
        Unsafe.putByteVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static char getCharVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getCharVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putCharVolatile(Object object, Class<?> type, String fieldName, char value) {
        Unsafe.putCharVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static short getShortVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getShortVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putShortVolatile(Object object, Class<?> type, String fieldName, short value) {
        Unsafe.putShortVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static int getIntVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getIntVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putIntVolatile(Object object, Class<?> type, String fieldName, int value) {
        Unsafe.putIntVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static long getLongVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getLongVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putLongVolatile(Object object, Class<?> type, String fieldName, long value) {
        Unsafe.putLongVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static float getFloatVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getFloatVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putFloatVolatile(Object object, Class<?> type, String fieldName, float value) {
        Unsafe.putFloatVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static double getDoubleVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getDoubleVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putDoubleVolatile(Object object, Class<?> type, String fieldName, double value) {
        Unsafe.putDoubleVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static <T> T getReferenceVolatile(Object object, Class<?> type, String fieldName) {
        return Unsafe.getReferenceVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)));
    }

    public static void putReferenceVolatile(Object object, Class<?> type, String fieldName, Object value) {
        Unsafe.putReferenceVolatile(object, Unsafe.objectFieldOffset(Fields.get(type, fieldName)), value);
    }
    ...
    public static Object getVolatile(Object object, Class<?> type, long offset) {
        if (type == boolean.class) return Unsafe.getBooleanVolatile(object, offset);
        if (type == byte.class) return Unsafe.getByteVolatile(object, offset);
        if (type == char.class) return Unsafe.getCharVolatile(object, offset);
        if (type == short.class) return Unsafe.getShortVolatile(object, offset);
        if (type == int.class) return Unsafe.getIntVolatile(object, offset);
        if (type == long.class) return Unsafe.getLongVolatile(object, offset);
        if (type == float.class) return Unsafe.getFloatVolatile(object, offset);
        if (type == double.class) return Unsafe.getDoubleVolatile(object, offset);

        return Unsafe.getReferenceVolatile(object, offset);
    }

    public static void put(Object object, Class<?> type, long offset, Object value) {
        if (type == boolean.class) Unsafe.putBoolean(object, offset, (boolean) value);
        ...
        else if (type == int.class) Unsafe.putInt(object, offset, (int) value);
        ...
        else Unsafe.putReference(object, offset, value);
    }

    public static void putVolatile(Object object, Class<?> type, long offset, Object value) {
        if (type == boolean.class) Unsafe.putBooleanVolatile(object, offset, (boolean) value);
        ...
        else if (type == int.class) Unsafe.putIntVolatile(object, offset, (int) value);
        ...
        else Unsafe.putReferenceVolatile(object, offset, value);
    }
